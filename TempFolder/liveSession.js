 ...
 * @param   integer     expiry          Seconds before the item is expire, where it will invoke the requestCall. In other word, when shall the data refresh.
 * @return  Null.
...
//localStorage live amoung browser's windows, it will save alot of fetch request as all windows will watching at the same local item, and only require one request when the item expired.
